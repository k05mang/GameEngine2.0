...
public class SpotLight extends Light {
	...
	public SpotLight(float radius, float length, float xpos, float ypos, float zpos, Vec3 color, float intensity) {
		this(radius, length, xpos, ypos, zpos, color.x, color.y, color.z, intensity);
	}

	public SpotLight(float radius, float length, Vec3 position, float r, float g, float b, float intensity) {
		this(radius, length, position.x, position.y, position.z, r, g, b, intensity);
	}

	public SpotLight(float radius, float length, float xpos, float ypos, float zpos, float r, float g, float b, float intensity) {
